...
const ChatScreen = () => {
  ...
  // console.log("charScreenGroupData",groupData)
  // get groupData by groupid
  const groupDataById=groupData.filter((grpitem)=>grpitem.group_id === groupId)
  // console.log(groupDataById,"groupDataById")
  // console.log(groupDataById[0].name)
  // console.log(groupDataById[0].group_picture)
  const group_name=groupDataById[0].name
  const group_picture=groupDataById[0].group_picture
